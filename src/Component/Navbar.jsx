        ...
        <div>
            <nav className="navbar navbar-expand-lg navbar-light bg-white py-3 shadow-sm">
                <div className="container">
                    <NavLink className="navbar-brand fw-bold fs-4" to="/">S-ONE MART</NavLink>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div className="buttons">
                            ...
                            <NavLink to="/cart" className="btn btn-outline-dark ms-2"><i className='fa fa-shopping-cart me-2'></i>Cart ({state.length})</NavLink>
                        </div>
                    </div>
                </div>
            </nav>
